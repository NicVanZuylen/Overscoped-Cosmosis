    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv_Opacity = packedInput.ase_texcoord5.xy * _Opacity_ST.xy + _Opacity_ST.zw;
				...
				surfaceDescription.Emission = ( _EmissionColour * tex2D( _Emission, uv_Emission ) ).rgb;
        ...
        Pass
        {
					...
					)
			{
				...
				float2 uv_Opacity = packedInput.interp03.xy * _Opacity_ST.xy + _Opacity_ST.zw;
...
WireConnection;10;7;22;0
WireConnection;10;9;27;0
ASEEND*/
//CHKSM=5705FF0249672CCA6D0AB1C009771519679EF7C6