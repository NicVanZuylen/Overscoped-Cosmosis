...
Shader "Cosmosis/Burt/PlantLife"
{
    Properties
    {
    ...
    {        
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float temp_output_54_0 = (0.0 + (inputMesh.positionOS.y - -0.5) * (1.0 - 0.0) / (1.0 - -0.5));
						...
						)
			{
				...
				float temp_output_54_0 = (0.0 + (packedInput.ase_texcoord5.xyz.y - -0.5) * (1.0 - 0.0) / (1.0 - -0.5));
				float Var_YGrad78 = temp_output_54_0;
				float temp_output_87_0 = ( _Time.y + unity_WorldTransformParams.x + unity_WorldTransformParams.z );
				float temp_output_55_0 = (0.0 + (sin( ( ( temp_output_87_0 * _PulseSpeed ) + ( 4.0 * temp_output_54_0 ) ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0));
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{			
					...
					BuiltinData builtinData;
					GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
					float temp_output_54_0 = (0.0 + (packedInput.ase_texcoord.xyz.y - -0.5) * (1.0 - 0.0) / (1.0 - -0.5));
					float Var_YGrad78 = temp_output_54_0;
					float temp_output_87_0 = ( _Time.y + unity_WorldTransformParams.x + unity_WorldTransformParams.z );
					float temp_output_55_0 = (0.0 + (sin( ( ( temp_output_87_0 * _PulseSpeed ) + ( 4.0 * temp_output_54_0 ) ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0));
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;2240.846;-65.84029;1;True;False
...
Node;AmplifyShaderEditor.WorldTransformParams;97;-2274.846,269.8403;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;61;-2187.191,196.2434;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;87;-2005.825,250.3743;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;54;-1472.755,287.4207;Float;False;5;0;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-1192.992,648.8434;Float;False;Property;_SwaySpeed;Sway Speed;4;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;68;-1192.612,728.0457;Float;False;Property;_SwayDir;Sway Dir;5;0;Create;True;0;0;False;0;0.22,0,0;0.04,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=E980C45931DDCE1292D600D23D28FC271C8AA460