    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float temp_output_56_0 = ( 1.0 - _Dissolve );
				float4 temp_cast_1 = (( temp_output_56_0 - _EmissionEdge )).xxxx;
				float2 uv025 = packedInput.ase_texcoord5.xy * _DissolveTiling + float2( 0,0 );
				float4 tex2DNode19 = tex2D( _DissolveNoise, uv025 );
				
				float4 temp_cast_3 = (temp_output_56_0).xxxx;
		...
		Pass
        {
					...
					)
			{
				...
				float4 tex2DNode19 = tex2D( _DissolveNoise, uv025 );
				float temp_output_56_0 = ( 1.0 - _Dissolve );
				float4 temp_cast_0 = (temp_output_56_0).xxxx;
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;2308.649;67.71448;1;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;36;-2029.869,-87.96706;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-2028.869,-5.967074;Float;False;Property;_PulseSpeed;Pulse Speed;9;0;Create;True;0;0;False;0;3.3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-1564.284,413.1198;Float;False;Property;_Dissolve;Dissolve;3;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;38;-1724.868,-56.96706;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;26;-1926.18,281.9159;Float;False;Property;_DissolveTiling;Dissolve Tiling;5;0;Create;True;0;0;False;0;1,1;3,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;32;-1303.81,139.5273;Float;False;Property;_EmissionEdge;Emission Edge;2;0;Create;True;0;0;False;0;0.05;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;56;-1300.649,414.2855;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;8;-1005.342,-230.0633;Float;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;None;bb1f0998d7fa23a4d8d1da525edf192a;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
ASEEND*/
//CHKSM=863F001D17241E9C1C0269EA850B1EBB510BDB78