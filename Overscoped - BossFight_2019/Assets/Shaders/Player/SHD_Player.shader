    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float temp_output_27_0 = (( (float)0 - 0.0 ) + (_Dissolve - (float)0) * (( 1 + 0.0 ) - ( (float)0 - 0.0 )) / ((float)1 - (float)0));
				...
				float smoothstepResult18 = smoothstep( ( temp_output_27_0 - 0.0 ) , ( temp_output_27_0 + 0.0 ) , clampResult45);
...
/*ASEBEGIN
Version=16900
1978;26;1906;999;1570.933;61.91721;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1075.194,592.3063;Float;False;Constant;_FSmooth;F. Smooth;5;0;Create;True;0;0;False;0;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-998.3943,351.7063;Float;False;Property;_Dissolve;Dissolve;5;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;24;-269.3943,139.7063;Float;False;Property;_DissolveEdgeColour;Dissolve Edge Colour;6;1;[HDR];Create;True;0;0;False;0;0,0,0,0;766.9961,16.06275,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AFDD0ED1B94A46E550B803E4E616153BED8B0E76