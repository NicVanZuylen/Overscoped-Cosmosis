    ...
    {        
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float temp_output_55_0 = (0.0 + (sin( ( ( _Time.y * _PulseSpeed ) + ( 4.0 * temp_output_54_0 ) ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0));
				float Var_YGrad78 = temp_output_54_0;
				
				outputPackedVaryingsMeshToPS.ase_texcoord5 = float4(inputMesh.positionOS,0);
				float3 vertexValue = ( ( temp_output_55_0 * _PulseStrength * Var_YGrad78 * inputMesh.normalOS ) + ( Var_YGrad78 * sin( ( _Time.y * _SwaySpeed ) ) * _SwayDir ) );
...
/*ASEBEGIN
Version=16800
125;86;1665;911;1479.267;568.3101;1.3;True;False
Node;AmplifyShaderEditor.CommentaryNode;72;-1681.538,-3.012173;Float;False;1290.857;530.2683;Pulsing;15;55;40;42;38;78;59;37;56;35;57;34;54;58;36;43;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1458.298,121.0591;Float;False;Property;_PulseSpeed;Pulse Speed;2;0;Create;True;0;0;False;0;-2;-2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;34;-1453.941,46.98783;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-1283.507,85.81391;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;71;-1205.191,536.2434;Float;False;650.0002;335;Swaying;7;67;68;65;63;66;61;81;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;61;-1189.191,586.2434;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-895.012,295.7943;Float;False;Property;_PulseStrength;Pulse Strength;3;0;Create;True;0;0;False;0;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;81;-883.8248,579.2831;Float;False;78;Var_YGrad;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;68;-885.6116,723.0457;Float;False;Property;_SwayDir;Sway Dir;5;0;Create;True;0;0;False;0;0.22,0,0;0.22,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;79;-733.6917,-95.71244;Float;False;78;Var_YGrad;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;70;-746.5698,-262.7328;Float;False;Property;_EmissionColour;Emission Colour;1;1;[HDR];Create;True;0;0;False;0;0,1.883055,1.597147,0;0,1.883055,1.597147,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;69;-750.1812,-431.3448;Float;False;Property;_BaseColour;Base Colour;0;0;Create;True;0;0;False;0;0.3962264,0.2336241,0.3293434,0;0.3962264,0.2336241,0.3293434,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=74B21D276FAF84D19DA45EC4202B8BF20F4CDADF