...
Shader "Cosmosis/Burt/Archived/Radial"
{
    Properties
    {
		...
		_Rough("Rough", Float) = 0.3
		_ColourMultiplier("Colour Multiplier", Color) = (1,1,1,0)
    }
    ...
    {        
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 _ColourMultiplier;
				sampler2D _TextureSample0;
				uniform sampler2D _Sampler6014;
				float2 _Tiling;
				float2 _Offset;
				float _Metal;
				float _Rough;
						...
						)
			{
				...
				float2 uv080_g1 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv081_g1 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv034 = packedInput.ase_texcoord5.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g1 = ( uv034 - float2( 1,1 ) );
                ...
                surfaceDescription.Albedo = ( _ColourMultiplier * tex2D( _TextureSample0, ( ( (tex2D( _Sampler6014, ( appendResult10_g1 + appendResult24_g1 ) )).rg * 1.0 ) + ( _Tiling * appendResult58_g1 ) ) ) ).rgb;
                ...
                surfaceDescription.Smoothness = ( 1.0 - _Rough );
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{			
					...
					float2 appendResult24_g1 = (float2((panner18_g1).x , (panner19_g1).y));
					float2 temp_output_47_0_g1 = _Offset;
					float2 uv034 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
					float2 temp_output_31_0_g1 = ( uv034 - float2( 1,1 ) );
					float2 appendResult39_g1 = (float2(frac( ( atan2( (temp_output_31_0_g1).x , (temp_output_31_0_g1).y ) / TWO_PI ) ) , length( temp_output_31_0_g1 )));
					float2 panner54_g1 = ( ( (temp_output_47_0_g1).x * _Time.y ) * float2( 1,0 ) + appendResult39_g1);
					float2 panner55_g1 = ( ( _Time.y * (temp_output_47_0_g1).y ) * float2( 0,1 ) + appendResult39_g1);
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;1647.544;463.0876;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;34;-1416.849,123.4376;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;17;-1358.849,-119.5624;Float;False;Property;_Tiling;Tiling;2;0;Create;True;0;0;False;0;1,1;15,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;18;-1365.849,0.4376221;Float;False;Property;_Offset;Offset;1;0;Create;True;0;0;False;0;0,-0.2;0,0.02;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;14;-1162.849,-83.56237;Float;False;RadialUVDistortion;-1;;1;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler6014;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;47;FLOAT2;1,1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;13;-754.8488,-99.56241;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;a01471bbdcd050b48a3401f426016d70;f341828760f6f3b4d8777ed19ab23e7b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;36;-684.0626,-271.4268;Float;False;Property;_ColourMultiplier;Colour Multiplier;5;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-461,43;Float;False;Property;_Rough;Rough;4;0;Create;True;0;0;False;0;0.3;0.66;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;21;-302,46;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-429.6995,-159.5953;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-444,-43;Float;False;Property;_Metal;Metal;3;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;12;0,0;Float;False;False;2;Float;ASEMaterialInspector;0;1;Hidden/Templates/HDSRPLit;091c43ba8bd92c9459798d59b089ce4e;True;Forward;0;8;Forward;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;False;-1;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;True;True;2;False;-1;255;False;-1;7;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;3;False;-1;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;26;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT;0;False;14;FLOAT;0;False;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;18;FLOAT3;0,0,0;False;19;FLOAT;0;False;20;FLOAT;0;False;21;FLOAT;0;False;22;FLOAT;0;False;23;FLOAT3;0,0,0;False;24;FLOAT;0;False;25;FLOAT;0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;0
...
WireConnection;14;68;17;0
WireConnection;14;47;18;0
WireConnection;14;29;34;0
WireConnection;13;1;14;0
WireConnection;21;0;20;0
WireConnection;35;0;36;0
WireConnection;35;1;13;0
WireConnection;4;0;35;0
WireConnection;4;4;19;0
WireConnection;4;7;21;0
ASEEND*/
//CHKSM=1870D4F8C358D285600C9F418886F72671A804CC