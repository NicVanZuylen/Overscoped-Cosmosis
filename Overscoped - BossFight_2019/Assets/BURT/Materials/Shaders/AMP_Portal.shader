        ...
        Pass
        {
            ...
            HLSLPROGRAM
						...
						)
				{
					...
					float4 clampResult116 = clamp( ( temp_output_125_0 + ( pow( temp_output_125_0 , 0.8 ) - tex2D( _Noise, ( ( (tex2D( _Sampler6082, ( appendResult10_g4 + appendResult24_g4 ) )).rg * 1.0 ) + ( _NoiseTiling * appendResult58_g4 ) ) ) ) ) , temp_cast_0 , temp_cast_1 );
...
/*ASEBEGIN
Version=16800
1921;1;1918;1017;239.824;-2011.596;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;128;1780.789,2521.429;Float;False;Property;_AlphaClipThreshold;Alpha Clip Threshold;8;0;Create;True;0;0;False;0;0;0.25;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F53D39DB673933D5A6BC8038294EE629859AA072