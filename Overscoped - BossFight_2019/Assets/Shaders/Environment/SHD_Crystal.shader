...
Shader "Cosmosis/Burt/Crystals"
{
    Properties
    {
		_CrystalTexture("Crystal Texture", 2D) = "white" {}
		_ColourH("Colour H", Color) = (0,0,0,0)
		_ColourL("Colour L", Color) = (0,0,0,0)
    ...
    {        
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 appendResult35 = (float3(0.0 , 0.1 , 0.0));
				
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = inputMesh.ase_texcoord.xy;
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = 0;
				float3 vertexValue = ( sin( ( _Time.y * 1.0 ) ) * appendResult35 );
						...
						)
			{
				...
				float2 uv_CrystalTexture = packedInput.ase_texcoord5.xy * _CrystalTexture_ST.xy + _CrystalTexture_ST.zw;
				float4 lerpResult16 = lerp( _ColourL , _ColourH , tex2D( _CrystalTexture, uv_CrystalTexture ).b);
				...
				surfaceDescription.Emission = ( lerpResult16 * (2.0 + (( sin( ( _Time.y * 2.0 ) ) * _EmissionStrength ) - ( 1.0 - _EmissionStrength )) * (_EmissionStrength - 2.0) / (_EmissionStrength - ( 1.0 - _EmissionStrength ))) ).rgb;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{			
					...
					BuiltinData builtinData;
					GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
					float2 uv_CrystalTexture = packedInput.ase_texcoord.xy * _CrystalTexture_ST.xy + _CrystalTexture_ST.zw;
					float4 lerpResult16 = lerp( _ColourL , _ColourH , tex2D( _CrystalTexture, uv_CrystalTexture ).b);
...
/*ASEBEGIN
Version=16900
1921;1;1918;1017;936.542;256.1811;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;21;-910.88,186.2385;Float;False;Constant;_PulseSpeed;Pulse Speed;6;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;19;-908.88,111.2385;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-740.88,128.2385;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-486.6477,472.3143;Float;False;Constant;_MotionSpeed;Motion Speed;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;29;-487.6477,391.3143;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-719,234;Float;False;Property;_EmissionStrength;Emission Strength;3;0;Create;True;0;0;False;0;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;18;-600.88,135.2385;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-467.88,126.2385;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-308.6477,433.3143;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;24;-472.88,224.2385;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-770.8,-65.3;Float;True;Property;_CrystalTexture;Crystal Texture;0;0;Create;True;0;0;False;0;None;55abc3d6fc8ad5745a136c5916fa87c7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;36;-368.6477,627.3143;Float;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;17;-476,-43;Float;False;Property;_ColourH;Colour H;1;0;Create;True;0;0;False;0;0,0,0,0;0.5608309,0.1682092,0.7924528,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;25;-736.88,312.2385;Float;False;Constant;_MinEmissionStrength;Min Emission Strength;6;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-421.6477,552.3143;Float;False;Constant;_MotionStrength;Motion Strength;6;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-479,-212;Float;False;Property;_ColourL;Colour L;2;0;Create;True;0;0;False;0;0,0,0,0;0.00475471,0,0.2735848,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;35;-184.6477,525.3143;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;16;-213,-36;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SinOpNode;32;-173.6477,433.3143;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;23;-308.88,203.2385;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-49.64771,450.3143;Float;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-35,245;Float;False;Property;_Smooth;Smooth;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-33,66;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-38,169;Float;False;Property;_Metal;Metal;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F87199372339D8671AFD6BC26DEC0B3DE9CB9D1B