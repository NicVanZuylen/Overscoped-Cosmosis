...
Shader "Cosmosis/Boss/Projectile_Energy"
{
    Properties
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
						...
						)
				{
					...
					float2 uv080_g3 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 appendResult10_g3 = (float2(( (temp_output_1_0_g3).x * uv080_g3.x ) , ( uv080_g3.y * (temp_output_1_0_g3).y )));
					float2 temp_output_11_0_g3 = float2( 0,0 );
					float2 uv081_g3 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 panner18_g3 = ( ( (temp_output_11_0_g3).x * _Time.y ) * float2( 1,0 ) + uv081_g3);
					float2 panner19_g3 = ( ( _Time.y * (temp_output_11_0_g3).y ) * float2( 0,1 ) + uv081_g3);
					float2 appendResult24_g3 = (float2((panner18_g3).x , (panner19_g3).y));
					float2 temp_output_47_0_g3 = _Offset;
					float2 uv078_g3 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
					float2 temp_output_31_0_g3 = ( uv078_g3 - float2( 1,1 ) );
					...
					float4 clampResult21 = clamp( ( tex2D( _Noise1, ( ( (tex2D( _Sampler604, ( appendResult10_g3 + appendResult24_g3 ) )).rg * 1.0 ) + ( _Tiling * appendResult58_g3 ) ) ) + tex2D( _Noise2, ( ( (tex2D( _Sampler6035, ( appendResult10_g2 + appendResult24_g2 ) )).rg * 1.0 ) + ( _Tiling * appendResult58_g2 ) ) ) ) , temp_cast_0 , temp_cast_1 );
...
/*ASEBEGIN
Version=16800
1927;26;1906;993;1427.428;26.83514;1;True;False
Node;AmplifyShaderEditor.Vector2Node;7;-1654,304.5;Float;False;Property;_Offset;Offset;7;0;Create;True;0;0;False;0;0,-0.5;0.1,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;39;-1672.089,432.1737;Float;False;Property;_NoiseDifference;Noise Difference;8;0;Create;True;0;0;False;0;-0.2,-0.3;0.15,-0.4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;6;-1632,181.5;Float;False;Property;_Tiling;Tiling;6;0;Create;True;0;0;False;0;2,1;1,0.66;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;4;-1341,90.5;Float;False;RadialUVDistortion;-1;;3;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler604;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;1,1;False;47;FLOAT2;1,1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-811.2408,704.2078;Float;False;Property;_AlphaAdjust;Alpha Adjust;5;0;Create;True;0;0;False;0;0.2;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-397.5197,-36.46985;Float;False;Property;_Colour2;Colour 2;1;1;[HDR];Create;True;0;0;False;0;0,0.2465773,1,0;4,0,0.04188538,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;15;-444.2406,132.3077;Float;False;Property;_Colour1;Colour 1;0;1;[HDR];Create;True;0;0;False;0;686.6824,0,1024,0;3.262745,0,47.93726,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;94,262;Float;False;True;2;Float;ASEMaterialInspector;0;4;Cosmosis/Boss/Projectile_Energy;dfe2f27ac20b08c469b2f95c236be0c3;True;Forward Unlit;0;1;Forward Unlit;5;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;False;False;True;2;False;-1;False;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;4;True;True;True;True;False;5;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=8E2F6B0A56B4C455B37A37A2085F1DF6F7C55839