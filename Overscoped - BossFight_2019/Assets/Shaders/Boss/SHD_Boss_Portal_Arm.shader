    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv_AlbedoTexture = packedInput.ase_texcoord5.xy * _AlbedoTexture_ST.xy + _AlbedoTexture_ST.zw;
                ...
                surfaceDescription.Albedo = ( tex2D( _AlbedoTexture, uv_AlbedoTexture ) + ( ( 1.0 - distanceDepth22 ) * _ColourFade ) ).rgb;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{			
					...
					BuiltinData builtinData;
					GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
					float2 uv_AlbedoTexture = packedInput.ase_texcoord.xy * _AlbedoTexture_ST.xy + _AlbedoTexture_ST.zw;
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;1615.838;175.7726;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;11;-969,496;Float;False;Property;_PlaneOrigin;Plane Origin;3;0;Create;True;0;0;False;0;0,0,0;-43.85071,183.8262,257.4105;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-1015,342;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ColorNode;24;-1010.971,13.65894;Float;False;Property;_ColourFade;Colour Fade;1;1;[HDR];Create;True;0;0;False;0;0.7169812,0.05749378,0.1131892,0;23.96863,23.96863,23.96863,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;10;-827,227;Float;False;Property;_PlaneNormal;Plane Normal;4;0;Create;True;0;0;False;0;0,1,0;0.0439475,0.6541616,-0.7550769;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;28;-850.838,-293.7726;Float;True;Property;_AlbedoTexture;Albedo Texture;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A2F8A6127C76544085E74A88DE8AFB661D673F35