...
Shader "Cosmosis/Boss/Meteor_Explosion_Heat"
{
    Properties
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
						...
						)
				{
					...
					float4 uv022 = packedInput.ase_texcoord;
					uv022.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float temp_output_23_0 = ( 1.0 - uv022.z );
					float2 uv019 = packedInput.ase_texcoord.xy * _Tiling + ( _Time.y * _Offset );
					float4 tex2DNode4 = tex2D( _NoiseTexture, uv019 );
					
					surfaceDescription.Alpha = step( temp_output_23_0 , tex2DNode4.r );
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput ) : SV_Target
				{
					...
					float2 uv019 = packedInput.ase_texcoord.xy * _Tiling + ( _Time.y * _Offset );
					float4 tex2DNode4 = tex2D( _NoiseTexture, uv019 );
					float4 lerpResult8 = lerp( _ColourL , _ColourH , step( ( 0.1 + temp_output_23_0 ) , tex2DNode4.r ));
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;1065.753;209.4763;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;24;-1227.753,416.5237;Float;False;257;216;Custom Vertex Stream;1;22;;0,0.9862151,1,1;0;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-1205.753,460.5237;Float;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;23;-925.7531,321.5237;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;11;-554.5,307;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;60,134;Float;False;True;2;Float;ASEMaterialInspector;0;4;Cosmosis/Boss/Meteor_Explosion_Heat;dfe2f27ac20b08c469b2f95c236be0c3;True;Forward Unlit;0;1;Forward Unlit;5;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;True;2;False;-1;False;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=HDRenderPipeline;RenderType=TransparentCutout=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;4;True;True;True;True;False;5;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=2882F6166B3BB0117FD03F229D4FB4EEEB041EEB