...
Shader "Shaders_Burt/Alan/Water"
{
    Properties
    {
		_WaveGradientTexture("Wave Gradient Texture", 2D) = "white" {}
		_ATiling("[A] Tiling", Vector) = (1,1,0,0)
		_AOffset("[A] Offset", Vector) = (0,0,0,0)
		_ARotation("[A] Rotation", Float) = 0.7
		_BTiling("[B] Tiling", Vector) = (0.3,0.3,0,0)
		_BOffset("[B] Offset", Vector) = (0,0,0,0)
		_BRotation("[B] Rotation", Float) = -0.3
		_CTiling("[C] Tiling", Vector) = (0.1,0.1,0,0)
		_COffset("[C] Offset", Vector) = (0,0,0,0)
		_CRotation("[C] Rotation", Float) = 0
		_WaveStrength("Wave Strength", Float) = 0.5
		_ColourHigh("Colour High", Color) = (0,0.05740881,1,0)
		_ColourLow("Colour Low", Color) = (1,0,0,0)
    ...
    {        
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				sampler2D _WaveGradientTexture;
				float2 _ATiling;
				float2 _AOffset;
				float _ARotation;
				float2 _BTiling;
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float cos13 = cos( _ARotation );
				float sin13 = sin( _ARotation );
				float2 rotator13 = mul( (appendResult21*_ATiling + ( _Time.y * _AOffset )) - float2( 0,0 ) , float2x2( cos13 , -sin13 , sin13 , cos13 )) + float2( 0,0 );
				float2 appendResult26 = (float2(ase_worldPos.x , ase_worldPos.z));
				float cos31 = cos( _BRotation );
				float sin31 = sin( _BRotation );
				float2 rotator31 = mul( (appendResult26*_BTiling + ( _Time.y * _BOffset )) - float2( 0,0 ) , float2x2( cos31 , -sin31 , sin31 , cos31 )) + float2( 0,0 );
				float2 appendResult35 = (float2(ase_worldPos.x , ase_worldPos.z));
				float cos38 = cos( _CRotation );
				float sin38 = sin( _CRotation );
				float2 rotator38 = mul( (appendResult35*_CTiling + ( _Time.y * _COffset )) - float2( 0,0 ) , float2x2( cos38 , -sin38 , sin38 , cos38 )) + float2( 0,0 );
				...
				float3 vertexValue = ( ( tex2Dlod( _WaveGradientTexture, float4( rotator13, 0, 0.0) ) + tex2Dlod( _WaveGradientTexture, float4( rotator31, 0, 0.0) ) + tex2Dlod( _WaveGradientTexture, float4( rotator38, 0, 0.0) ) ) * float4( float3(0,1,0) , 0.0 ) * _WaveStrength ).rgb;
						...
						)
			{
				...
				float screenDepth64 = LinearEyeDepth( SampleCameraDepth( screenPos.xy/screenPos.w ).r,_ZBufferParams);
				float distanceDepth64 = saturate( abs( ( screenDepth64 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) ) );
				float4 lerpResult55 = lerp( _ColourLow , _ColourHigh , distanceDepth64);
				
                surfaceDescription.Albedo = lerpResult55.rgb;
...
/*ASEBEGIN
Version=16800
1;1;1918;1017;2644.488;441.1061;1.688855;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;18;-1871,83;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;20;-1868,-119;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector2Node;24;-1867.667,578.1111;Float;False;Property;_BOffset;[B] Offset;5;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.WorldPosInputsNode;23;-1872.667,299.1111;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleTimeNode;25;-1875.667,501.1111;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;15;-1863,154;Float;False;Property;_AOffset;[A] Offset;2;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;34;-1893.667,925.3112;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;33;-1890.667,723.3112;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector2Node;40;-1885.667,1002.311;Float;False;Property;_COffset;[C] Offset;8;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;21;-1671,-94;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-1675.667,324.1111;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;19;-1691,7;Float;False;Property;_ATiling;[A] Tiling;1;0;Create;True;0;0;False;0;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;28;-1695.667,425.1111;Float;False;Property;_BTiling;[B] Tiling;4;0;Create;True;0;0;False;0;0.3,0.3;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1688.667,549.1111;Float;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-1684,131;Float;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-1706.667,973.3111;Float;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;39;-1713.667,849.3112;Float;False;Property;_CTiling;[C] Tiling;7;0;Create;True;0;0;False;0;0.1,0.1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;35;-1693.667,748.3112;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-1487.667,998.3111;Float;False;Property;_CRotation;[C] Rotation;9;0;Create;True;0;0;False;0;0;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;37;-1511.667,853.3112;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1465,156;Float;False;Property;_ARotation;[A] Rotation;3;0;Create;True;0;0;False;0;0.7;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;29;-1493.667,429.1111;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;22;-1489,11;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1469.667,574.1111;Float;False;Property;_BRotation;[B] Rotation;6;0;Create;True;0;0;False;0;-0.3;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;38;-1300.667,890.3112;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RotatorNode;31;-1282.667,466.1111;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;32;-1450.683,231.0418;Float;True;Property;_WaveGradientTexture;Wave Gradient Texture;0;0;Create;True;0;0;False;0;4684d4d4b26304945be8e3ee22c93311;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RotatorNode;13;-1278,48;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-728.7286,7.784058;Float;False;Property;_DepthDistance;Depth Distance;17;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-1064,454;Float;True;Property;_TextureSample2;Texture Sample 2;2;0;Create;True;0;0;False;0;4684d4d4b26304945be8e3ee22c93311;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1056,243;Float;True;Property;_TextureSample1;Texture Sample 1;1;0;Create;True;0;0;False;0;4684d4d4b26304945be8e3ee22c93311;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-1056,44;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;4684d4d4b26304945be8e3ee22c93311;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;57;-640.9253,-353.3022;Float;False;Property;_ColourLow;Colour Low;12;0;Create;True;0;0;False;0;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;43;-626.6998,277.2;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector3Node;51;-671.9253,462.6978;Float;False;Constant;_Vector0;Vector 0;10;0;Create;True;0;0;False;0;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ColorNode;56;-646.9253,-186.3022;Float;False;Property;_ColourHigh;Colour High;11;0;Create;True;0;0;False;0;0,0.05740881,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;52;-688.9253,614.6978;Float;False;Property;_WaveStrength;Wave Strength;10;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;64;-529.7286,1.784058;Float;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-460.9253,468.6978;Float;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;61;-963.4636,-250.8429;Float;True;Property;_TextureSample3;Texture Sample 3;15;0;Create;True;0;0;False;0;6d0d6ebbb5dca5d499cedd4f5e832c4b;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;63;-319.7286,343.7841;Float;False;Property;_Alpha;Alpha;16;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;55;-290.9253,-90.30225;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;59;-322.4636,180.1571;Float;False;Property;_Metal;Metal;13;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-318.4636,264.1571;Float;False;Property;_Smooth;Smooth;14;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=31A68B38A4FFF1B59F4BCB28660764B2E871C385