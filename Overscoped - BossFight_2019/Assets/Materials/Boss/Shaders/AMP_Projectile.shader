...
Shader "Shaders_Burt/Projectile"
{
    Properties
    {
		...
		_NoiseTiling("Noise Tiling", Vector) = (3,1,0,0)
		_NoiseOffset("Noise Offset", Vector) = (0,0.5,0,0)
    }
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput ) : SV_Target
				{
					...
					float4 clampResult38 = clamp( ( ( ( tex2D( _NoiseTexture, ((ase_screenPosNorm).xy*_NoiseTiling + ( _NoiseOffset * _Time.y )) ) * _NoiseStrength ) * fresnelNode5 ) + fresnelNode5 ) , temp_cast_1 , temp_cast_2 );
					float4 lerpResult11 = lerp( temp_cast_0 , _Colour , clampResult38);
					
					surfaceDescription.Color =  lerpResult11.rgb;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
...
/*ASEBEGIN
Version=16800
0;73;1924;928;863.3774;278.4323;1;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;15;-1310.764,61.28521;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;23;-1272.403,230.5333;Float;False;Property;_NoiseOffset;Noise Offset;6;0;Create;True;0;0;False;0;0,0.5;0,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;35;-1269.6,357.2588;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;27;-1105.987,68.27812;Float;False;True;True;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;19;-1097.755,149.4885;Float;False;Property;_NoiseTiling;Noise Tiling;5;0;Create;True;0;0;False;0;3,1;10,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-1095.6,278.2587;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;33;-879.9544,141.1451;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-579,377;Float;False;Property;_FresnelPower;Fresnel Power;1;0;Create;True;0;0;False;0;1;7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-574,302;Float;False;Property;_FresnelScale;Fresnel Scale;0;0;Create;True;0;0;False;0;0.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-385.6176,180.7851;Float;False;Property;_NoiseStrength;Noise Strength;4;0;Create;True;0;0;False;0;2;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-681.5947,104.3021;Float;True;Property;_NoiseTexture;Noise Texture;3;0;Create;True;0;0;False;0;e28dc97a9541e3642a48c0e3886688c5;e28dc97a9541e3642a48c0e3886688c5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;5;-392,257;Float;True;Standard;WorldNormal;ViewDir;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-228.948,114.3709;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-83.27295,151.5997;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;37;70.72705,231.5997;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;39;56.2271,331.5997;Float;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;51.2271,412.5997;Float;False;Constant;_Float1;Float 1;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;38;226.2271,289.5997;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;257.9522,43.78012;Float;False;Constant;_Float3;Float 3;0;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;199.9523,118.7801;Float;False;Property;_Colour;Colour;2;1;[HDR];Create;True;0;0;False;0;0.9261813,0,1,0;2.776471,0,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;11;453.1758,141.1831;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BBFE0D379A98974CE6733DBA608C29E61C07AAD0