        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
				{
					...
					float3 vertexValue =  ( ( tex2DNode4 * tex2DNode20 * tex2DNode22 * tex2DNode24 ) * float4( float3(0,1,0) , 0.0 ) * _HeightOffset * pow( ( 1.0 - uv054.y ) , 1.5 ) ).rgb;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput ) : SV_Target
				{
					...
					surfaceDescription.Color =  ( fetchOpaqueVal66 + ( _Colour * ( ( tex2DNode4 + _Alpha ) * ( tex2DNode20 + _Alpha ) * ( _Alpha + tex2DNode22 ) * ( _Alpha + tex2DNode24 ) ) * clampResult88 ) ).rgb;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
...
/*ASEBEGIN
Version=16900
1920;1;1906;1011;1326.847;531.7375;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-921.7354,-302.9814;Float;False;Property;_Alpha;Alpha;2;0;Create;True;0;0;False;0;0.2;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-235.847,-161.7375;Float;False;Property;_DepthDistance;Depth Distance;5;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;45;-715.7353,-170.9813;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;43;-717.7353,-349.9813;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;44;-716.7353,-260.9814;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;42;-718.7353,-438.9813;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;71.15295,238.2625;Float;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;False;0;1.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-559.2459,-340.5871;Float;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;89;-717.8469,66.26251;Float;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-73.84689,64.26251;Float;False;Property;_HeightOffset;Height Offset;4;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
WireConnection;89;0;4;0
WireConnection;89;1;20;0
WireConnection;89;2;22;0
WireConnection;89;3;24;0
...
ASEEND*/
//CHKSM=30EBB5FB8F85D2ACB3BE6D2A19FC8EF3483A6053