...
Shader "Cosmosis/Lasers/Laser_Beam_Edge"
{
    Properties
    {
		...
		_BeamTaperBack("Beam Taper Back", Range( 1 , 20)) = 0
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
				{
					...
					float2 uv0158 = inputMesh.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
					float temp_output_153_0 = distance( inputMesh.positionOS , _LineOrigin );
					float2 appendResult66 = (float2(uv0158.y , ( 1.0 - ( fmod( temp_output_153_0 , _TileLength ) * ( 1.0 / _TileLength ) ) )));
					float4 tex2DNode74 = tex2Dlod( _ColourTexture, float4( (appendResult66*_ColourTiling + ( _Time.y * _ColourOffset )), 0, 0.0) );
					float temp_output_159_0 = ( temp_output_153_0 / _LineLength );
					...
					float3 vertexValue =  ( ( tex2DNode74.r * _ColourVertexStrength * min( ( 1.0 - pow( ( 1.0 - ( 1.0 - temp_output_159_0 ) ) , _BeamTaperFront ) ) , ( 1.0 - pow( ( 1.0 - temp_output_159_0 ) , _BeamTaperBack ) ) ) * inputMesh.normalOS.xyz ) + ( min( ( 1.0 - pow( ( 1.0 - ( 1.0 - temp_output_159_0 ) ) , _BeamTaperFront ) ) , ( 1.0 - pow( ( 1.0 - temp_output_159_0 ) , _BeamTaperBack ) ) ) * inputMesh.normalOS.xyz * tex2Dlod( _VertexTexture, float4( (appendResult66*_VertexTiling + ( _Time.y * _VertexOffset )), 0, 0.0) ).r * _VertexStrength ) );
						...
						)
				{
					...
					float2 uv0158 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float temp_output_153_0 = distance( packedInput.ase_texcoord1.xyz , _LineOrigin );
					float2 appendResult66 = (float2(uv0158.y , ( 1.0 - ( fmod( temp_output_153_0 , _TileLength ) * ( 1.0 / _TileLength ) ) )));
		...
		Pass
		{
            ...
            HLSLPROGRAM
				...
				PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
				{
					...
					float2 uv0158 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
					float temp_output_153_0 = distance( inputMesh.positionOS , _LineOrigin );
					float2 appendResult66 = (float2(uv0158.y , ( 1.0 - ( fmod( temp_output_153_0 , _TileLength ) * ( 1.0 / _TileLength ) ) )));
					float4 tex2DNode74 = tex2Dlod( _ColourTexture, float4( (appendResult66*_ColourTiling + ( _Time.y * _ColourOffset )), 0, 0.0) );
					float temp_output_159_0 = ( temp_output_153_0 / _LineLength );
					...
					outputPackedVaryingsMeshToPS.ase_texcoord2.w = 0;
					outputPackedVaryingsMeshToPS.ase_texcoord3.w = 0;
					float3 vertexValue = ( ( tex2DNode74.r * _ColourVertexStrength * min( ( 1.0 - pow( ( 1.0 - ( 1.0 - temp_output_159_0 ) ) , _BeamTaperFront ) ) , ( 1.0 - pow( ( 1.0 - temp_output_159_0 ) , _BeamTaperBack ) ) ) * inputMesh.normalOS ) + ( min( ( 1.0 - pow( ( 1.0 - ( 1.0 - temp_output_159_0 ) ) , _BeamTaperFront ) ) , ( 1.0 - pow( ( 1.0 - temp_output_159_0 ) , _BeamTaperBack ) ) ) * inputMesh.normalOS * tex2Dlod( _VertexTexture, float4( (appendResult66*_VertexTiling + ( _Time.y * _VertexOffset )), 0, 0.0) ).r * _VertexStrength ) );
					#ifdef ASE_ABSOLUTE_VERTEX_POS
					inputMesh.positionOS.xyz = vertexValue; 
					#else
					inputMesh.positionOS.xyz += vertexValue;
...
/*ASEBEGIN
Version=16900
2040;46;1906;1011;-122.6218;101.1666;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;72;-1654.253,281.624;Float;False;1116.404;482.6399;0-1 Gradient + UVs;16;161;160;159;158;157;156;154;153;152;151;150;2;66;126;125;162;;1,1,1,1;0;0
Node;AmplifyShaderEditor.PosVertexDataNode;151;-1613.558,462.3432;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;150;-1635.558,613.3433;Float;False;Property;_LineOrigin;LineOrigin;0;0;Create;True;0;0;False;0;-244,-52,105;1426.885,404.7943,1859.886;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DistanceOpNode;153;-1407.558,546.3432;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;160;-1398.558,668.343;Float;False;Property;_LineLength;LineLength;2;0;Create;True;0;0;False;0;101;43.18762;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;159;-1228.043,623.563;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;152;-1418.043,393.563;Float;False;Property;_TileLength;TileLength;1;0;Create;True;0;0;False;0;20;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FmodOpNode;154;-1248.043,386.5629;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;161;-894.0432,543.563;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;162;-1221.378,485.8334;Float;False;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;126;-714.298,485.3339;Float;False;152.7418;125.8279;W to B;1;73;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;125;-716.1918,619.0035;Float;False;161.2848;112.8145;B to W;1;123;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RelayNode;123;-694.3701,658.262;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RelayNode;73;-692.7744,526.7908;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;128;-456.866,542.8025;Float;False;719.731;350.6603;Beam Taper;9;124;143;145;139;144;140;146;142;149;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;156;-1083.043,396.563;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;157;-892.6041,469.1393;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;64;-383.3461,203.3679;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;149;-431.52,719.875;Float;False;Property;_BeamTaperBack;Beam Taper Back;14;0;Create;True;0;0;False;0;0;20;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;142;-323.293,788.524;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;146;-321.749,578.822;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;158;-946.7919,327.9609;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;140;-434.5811,644.3781;Float;False;Property;_BeamTaperFront;Beam Taper Front;13;0;Create;True;0;0;False;0;10;5;1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;62;-367.446,278.468;Float;False;Property;_ColourOffset;Colour Offset;4;0;Create;True;0;0;False;0;0,0;0.2,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;66;-715.498,377.6239;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node;68;-229.5565,64.59512;Float;False;Property;_ColourTiling;Colour Tiling;5;0;Create;True;0;0;False;0;1,1;1,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.PowerNode;144;-161.4706,592.712;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;139;-156.5917,749.052;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;108;-271.5539,1086.646;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;145;-10.80939,613.014;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;106;-114.8254,991.1891;Float;False;Property;_VertexTiling;Vertex Tiling;11;0;Create;True;0;0;False;0;1,1;1,2.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.OneMinusNode;143;-4.442505,744.946;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;74;178.6283,126.2543;Float;True;Property;_ColourTexture;Colour Texture;3;0;Create;True;0;0;False;0;None;e451e4a7415133e499b571c26159bd98;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMinOpNode;124;149.4754,666.226;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;86;461.3932,-19.29263;Float;False;Property;_Color1;Color 1;6;1;[HDR];Create;True;0;0;False;0;0,0,0,0;24.84706,0,47.93726,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RelayNode;163;334.6219,647.8334;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;113;531.9042,156.6594;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;85;461.3932,-195.2927;Float;False;Property;_Color0;Color 0;7;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.1333333,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;117;343.8461,558.3987;Float;False;Property;_ColourVertexStrength;Colour Vertex Strength;8;0;Create;True;0;0;False;0;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;110;361.0354,1205.737;Float;False;Property;_VertexStrength;Vertex Strength;10;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;148;998.6704,584.2809;Float;False;Property;_AlphaAdjust;Alpha Adjust;15;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;147;1170.174,517.3823;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;116;2;163;0
WireConnection;116;3;103;0
WireConnection;147;0;74;1
...
WireConnection;1;1;147;0
WireConnection;1;3;115;0
ASEEND*/
//CHKSM=9F31D1B21B2D281C2992CD852967BE066AFACFAF