...
Shader "Shaders_Burt/Test_Decal"
{
    Properties
    {
		...
		_ColourIntensity("Colour Intensity", Float) = 0
    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv012 = packedInput.ase_texcoord5.xy * _Tiling + ( _Offset * _Time.y );
				float4 tex2DNode11 = tex2D( _Alpha, uv012 );
				float4 temp_output_10_0 = ( ( _Colour * _ColourIntensity ) * tex2DNode11.r );
				
                surfaceDescription.Albedo = temp_output_10_0.rgb;
        ...
        Pass
        {
					...
					)
			{
				...
				float2 uv012 = packedInput.interp03.xy * _Tiling + ( _Offset * _Time.y );
				float4 tex2DNode11 = tex2D( _Alpha, uv012 );
		...
		Pass
        {
            ...
            HLSLPROGRAM
						...
						)
				{
					...
					SmoothSurfaceDescription surfaceDescription = (SmoothSurfaceDescription)0;
                    float2 uv012 = packedInput.ase_texcoord3.xy * _Tiling + ( _Offset * _Time.y );
                    float4 tex2DNode11 = tex2D( _Alpha, uv012 );
...
WireConnection;29;4;20;0
WireConnection;29;6;10;0
WireConnection;29;7;21;0
WireConnection;29;9;11;1
ASEEND*/
//CHKSM=140DF0A76E9E592EB94F5E9F1F507740FE56A7B0