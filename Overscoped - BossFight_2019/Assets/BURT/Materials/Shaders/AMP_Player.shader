...
Shader "Shaders_Burt/Player_Vitals"
{
    Properties
    {
		...
		_Mask("Mask", 2D) = "white" {}
		_Mana("Mana", Range( -0.1 , 1.2)) = 0.3743678
    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float4 clampResult34 = clamp( ( 0.5 + ( 1.0 - tex2DNode11 ) ) , temp_cast_0 , temp_cast_1 );
				
				float2 uv026 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult18 = smoothstep( ( _Mana - 0.05 ) , ( _Mana + 0.05 ) , uv026.y);
				
                surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo ) * clampResult34 ).rgb;
				...
				surfaceDescription.Emission = ( _EmissionColour * tex2DNode11 * smoothstepResult18 ).rgb;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{			
					...
					float2 uv026 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float smoothstepResult18 = smoothstep( ( _Mana - 0.05 ) , ( _Mana + 0.05 ) , uv026.y);
...
/*ASEBEGIN
Version=16800
1681;1;1678;987;1065.108;408.8536;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;12;-1220.81,12.86481;Float;True;Property;_Mask;Mask;2;0;Create;True;0;0;False;0;2a7affe02edcbed4a94aa2e8e24b1bff;2a7affe02edcbed4a94aa2e8e24b1bff;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.OneMinusNode;32;-578.6632,-159.2013;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1296.438,430.9561;Float;False;Constant;_Float1;Float 1;3;0;Create;True;0;0;False;0;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1405.438,340.9559;Float;False;Property;_Mana;Mana;3;0;Create;True;0;0;False;0;0.3743678;0;-0.1;1.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-586.4216,-232.3549;Float;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;10;-545.2016,-423.9413;Float;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-396.6632,-136.2013;Float;False;Constant;_Float2;Float 2;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-390.6632,-65.20129;Float;False;Constant;_Float3;Float 3;4;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;21;-1077.438,425.9561;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;22;-1090.438,333.9561;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-419.6632,-226.2013;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;34;-231.6632,-173.2013;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;9;-301.9075,-364.1849;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;16;-864.7208,-101.7733;Float;False;Property;_EmissionColour;Emission Colour;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;18;-920.7127,283.4034;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;113.5291,87.93272;Float;False;Constant;_Metal;Metal;1;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-602.9814,117.0083;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;14;83.52911,212.3111;Float;False;Constant;_Smooth;Smooth;1;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;8.336792,-238.2013;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=28294E471A11AAFFC1707F71E24F537EB9D54A14